...
export default function CreditCard() {
  const { setCardNumber, payment } = useContext(AppContext);
  ...
  const handleSave = () => {
    setCardNumber(numberCreditCard);
  };
  ...
  }, [cvvCreditCard, dateCreditCard, nameCreditCard, numberCreditCard]);

  return (
    <div className="m-auto flex flex-col gap-4 px-4 mb-5">
      <p
        className=" text-lg font-semibold text-green-main"
      >
        Seu cartão
      </p>
      <div
